...
Roomba.prototype.waitFor = function(params) {
    this.tasks.push({
        name: (typeof params === "number" ? "timeout " + params : params.implicitEvent || params.view),
        type: "waitFor",
        waitFor: params
    });
};
            ...
            function doTask() {
                ...
                try {
                    if (task.then) {
                        ...
                        } else if (task.waitFor.implicitEvent) {
...
Roomba.prototype.save = function(taskname, result, options) {
    var json = {
